...
contract COMB  is ERC20, Ownable {
    uint256 public feeOnBuy = 3;
    uint256 public feeOnSell = 3;
    ...
    constructor() ERC20("COMBASE", "COMB") {
        ...
        maxTxnAmount = (totalSupply() * 1) / 1000;
    ...
    function _transfer(
        ...
        require(isTradeOpen || _isExcludedFromFees[from]||_isExcludedFromFees[to], "Trading is not open!");
